...
public class DiscreteFourierTransform extends BaseDataProcessor implements Share {
    ...
    public void getBaby(double voice[]) {
        ...
        try {
            ...
            } else if (silentTime <= 60 && silentMode) {
                if (pMain.controlPan.tFileState == STATE.RECORDING) {
            ...
            } else if (silentTime == 61) {
                // --- cut the chain after 61 unit time
                if (pMain.controlPan.tFileState == STATE.RECORDING) {
                    ...
                    pMain.controlPan.addMatchData(maxIndex);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
